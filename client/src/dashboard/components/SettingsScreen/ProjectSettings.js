                ...
                <div className="settings-block-detail">
                    <div className="flex-row" style={{ width: "100%" }}>
                        ...
                        {formVisible ? (
                            ...
                            <div className="settings-block-detail-value">{props.settings.project_name || "NA"}</div>
                        )}
                    </div>
...
const ConnectedProjectSettings = connect(mapStateToProps)(ProjectSettings);

export default ConnectedProjectSettings;
